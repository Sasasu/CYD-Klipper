...
static void btn_print_file_verify(lv_event_t * e){
    ...
    lv_obj_set_size(panel, CYD_SCREEN_HEIGHT_PX - CYD_SCREEN_GAP_PX * 4, CYD_SCREEN_WIDTH_PX - CYD_SCREEN_GAP_PX * 3);
    ...
    lv_obj_set_width(label, CYD_SCREEN_HEIGHT_PX - CYD_SCREEN_GAP_PX * 10);
