...
void stats_panel_init(lv_obj_t* panel) {
    ...
    lv_obj_set_size(left_panel, panel_width, CYD_SCREEN_WIDTH_PX - CYD_SCREEN_GAP_PX * 2);
    ...
    lv_obj_set_size(right_panel, panel_width, CYD_SCREEN_WIDTH_PX - CYD_SCREEN_GAP_PX * 2);
