...
static void show_keyboard(lv_event_t * e){
    ...
    lv_obj_set_size(parent, CYD_SCREEN_PANEL_WIDTH_PX, CYD_SCREEN_WIDTH_PX);
...
void temp_panel_init(lv_obj_t * panel){
    ...
    lv_obj_set_size(root_temp_panel, CYD_SCREEN_PANEL_WIDTH_PX, CYD_SCREEN_WIDTH_PX);
    ...
    lv_obj_set_size(single_screen_panel, element_width, CYD_SCREEN_WIDTH_PX - CYD_SCREEN_GAP_PX * 2 - CYD_SCREEN_GAP_PX / 2);
